...
export default function AboutUsHero() {
  ...
  return (
    ...
    >
      ...
      <div className="container relative mx-auto max-w-6xl px-4 sm:px-6 md:px-8 z-10 pt-8 sm:pt-12 md:pt-16">
        <div
          className="relative"
          style={{
        ...
        >
          ...
          >
            <Image
              ...
              alt="Kvaornux iGaming platform provider"
              className="w-full h-auto"
              priority
            />
          </div>
          ...
          {/* Title */}
          <h1
            className="text-center mb-3 sm:mb-4 md:mb-6 px-2 text-white font-bold"
            style={{
