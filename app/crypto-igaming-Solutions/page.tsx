  ...
  const tabs = [
    {
      ...
      alt: 'Crypto iGaming Platform Full Ownership Interface and Design'
    },
    {
      id: 'game-aggregation',
      ...
      alt: 'Crypto Casino Game Aggregation API with 10,000+ Slots and Table Games'
    },
    {
      id: 'Fast-launch',
      label: 'Fast launch',
      ...
      alt: 'Turnkey Crypto iGaming Platform Fast Launch Infrastructure'
    },
    {
      id: 'compliance',
      ...
      alt: 'Crypto iGaming Security, Anti-Fraud Risk Management, and AML/KYC Protocols'
    },
    {
      id: 'backoffice',
      label: 'Back Office',
      ...
      alt: 'Crypto iGaming Back-Office Admin Panel with Wallet and Analytics Controls'
    }
  ];
