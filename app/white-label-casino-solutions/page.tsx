...
export const metadata = {
  ...
  keywords:
    "white label casino solution, crypto casino software, iGaming solution provider, sportsbook API, turnkey casino solution, online casino backend system",
};

export default function Page() {
  return <WhiteLabelCasinoPlatform />;
}